...
*/
  ...
  if ($('.nav-menu').length) {
    ...
    $('body').prepend('<button type="button" class="mobile-nav-toggle d-lg-none"><i class="icofont-navigation-menu"></i><span class="sr-only sr-only-focusable">Mobile Menu</span></button>');
